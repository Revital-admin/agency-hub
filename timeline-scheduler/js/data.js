...
const DEFAULT_TEMPLATES = [
  {
    ...
    phases: [
      ...
      { order: 12, name: "Review competitors and inspiration", offsetDays: 14 },
      { order: 13, name: "Set up the Framer or Webflow project", offsetDays: 15 },
      { order: 14, name: "Define page requirements and content", offsetDays: 18,
      ...
      { order: 22, name: "Build the website in Framer or Webflow", offsetDays: 44 },
  ...
  },
  {
    ...
    phases: [
      ...
      { order: 2,  name: "Client approval of concept and script", offsetDays: 2 },
      { order: 3,  name: "Location scout and venue tech-spec review", offsetDays: 3 },
      { order: 4,  name: "Confirm cast/talent and vendor/rental needs", offsetDays: 5 },
      { order: 5,  name: "Build the call sheet and run of show", offsetDays: 7 },
      { order: 6,  name: "Collect signed release forms", offsetDays: 7 },
      { order: 7,  name: "Conduct the pre-production meeting", offsetDays: 8 },
      { order: 8,  name: "Shoot day(s)", offsetDays: 10 },
      { order: 9,  name: "Ingest and back up raw footage", offsetDays: 11 },
      { order: 10, name: "Select footage and build the rough cut", offsetDays: 16 },
      { order: 11, name: "Internal review of the rough cut", offsetDays: 18 },
      { order: 12, name: "Client review and revision round(s)", offsetDays: 22 },
      { order: 13, name: "Finalize color, audio, and graphics", offsetDays: 25 },
      { order: 14, name: "Deliver final files", offsetDays: 28 },
      { order: 15, name: "Archive raw footage and close out project", offsetDays: 30 },
    ],
  },
  {
    id: "paid-ads-launch",
    ...
    phases: [
      ...
      { order: 7,  name: "Client review and approval of creative and budget", offsetDays: 13 },
      { order: 8,  name: "Build campaign structure and tracking/pixels", offsetDays: 15 },
      { order: 9,  name: "Internal QA via the Campaign Launch Pre-Flight Checklist", offsetDays: 17 },
      { order: 10, name: "Launch campaigns", offsetDays: 18 },
      { order: 11, name: "First optimization review (7-day check-in)", offsetDays: 25 },
    ],
  },
  {
  ...
  },
  {
    ...
    phases: [
      ...
      { order: 7,  name: "Implement updates in Framer or Webflow", offsetDays: 24 },
