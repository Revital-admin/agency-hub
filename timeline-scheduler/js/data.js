...
const DEFAULT_TEMPLATES = [
  ...
  },
  {
    ...
    phases: [
      { order: 1,  name: "Review contract, proposal, and SOW", offsetDays: 0 },
      { order: 2,  name: "Assign social strategist and project team", offsetDays: 1 },
      { order: 3,  name: "Run the Social Media Audit", offsetDays: 4 },
      { order: 4,  name: "Gather platform access and brand assets", offsetDays: 5 },
      { order: 5,  name: "Define content pillars and posting cadence", offsetDays: 9 },
      { order: 6,  name: "Build the first content calendar", offsetDays: 13 },
      { order: 7,  name: "Draft the first batch of posts", offsetDays: 17 },
      { order: 8,  name: "Client review and approval workflow set up", offsetDays: 20 },
      { order: 9,  name: "Begin scheduled posting", offsetDays: 22 },
      { order: 10, name: "First monthly performance report", offsetDays: 52 },
    ],
  },
  {
    ...
    phases: [
      { order: 1,  name: "Review contract, proposal, and SOW", offsetDays: 0 },
      { order: 2,  name: "Assign strategist and project team", offsetDays: 1 },
      { order: 3,  name: "Run the Email Marketing Audit", offsetDays: 4 },
      { order: 4,  name: "Gather ESP access and list exports", offsetDays: 5 },
      { order: 5,  name: "Clean and segment the list", offsetDays: 9 },
      { order: 6,  name: "Build email templates", offsetDays: 14 },
      { order: 7,  name: "Draft the first campaign(s)", offsetDays: 18 },
      { order: 8,  name: "Client review and revisions", offsetDays: 21 },
      { order: 9,  name: "Send the first campaign", offsetDays: 23 },
      { order: 10, name: "First performance review (opens, clicks, conversions)", offsetDays: 30 },
    ],
  },
  {
    ...
    phases: [
      ...
      { order: 2,  name: "Assign writer and project lead", offsetDays: 1 },
      { order: 3,  name: "Gather results, metrics, and supporting data", offsetDays: 3 },
      { order: 4,  name: "Conduct the client interview", offsetDays: 7 },
      { order: 5,  name: "Draft the case study or testimonial", offsetDays: 11 },
      { order: 6,  name: "Internal review", offsetDays: 13 },
      { order: 7,  name: "Client review and approval", offsetDays: 17 },
      { order: 8,  name: "Design and finalize the asset", offsetDays: 20 },
      { order: 9,  name: "Publish to portfolio/case study library", offsetDays: 22 },
      { order: 10, name: "Promote across social and email channels", offsetDays: 24 },
    ],
  },
];
