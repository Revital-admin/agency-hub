...
const EMAIL_TEMPLATES = [
  ...
  },
  {
    ...
    format: "html",
    date: "2026-07-21",
    content: "<p>Hi {{contactName}},</p><p>Welcome aboard! Attached is your Client Onboarding Form — this is how we learn everything we need to know about your business, brand, and goals before our kick-off call.</p><p>You can fill it out directly here: {{intakeFormLink}}</p><p>Please complete and return this within 48 hours so we can get your kick-off call on the calendar.</p><p>Talk soon,<br>{{accountManagerName}}</p>"
  },
  {
